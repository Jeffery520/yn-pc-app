(function() {
	...
	t != r &&
		null != t &&
		aa(l, ba, { configurable: !0, writable: !0, value: t });
	var ca = this;
	function u(a) {
		...
		for (var c = oa(a.f()), d = 0; d < c.length; d++) {
			...
			if (null != b.a[f]) {
				...
				if (e.h)
					...
					(e = E(b, f)),
						g ? ((g = E(a, f)) ? pa(g, e) : C(a, f, e.clone())) : C(a, f, e);
			}
		}
	}
	A.prototype.clone = function() {
		var a = new this.constructor();
		a != this && ((a.a = {}), a.b && (a.b = {}), pa(a, this));
		return a;
	};
	function E(a, b) {
		var c = a.a[b];
	...
	I.prototype.a = function(a, b) {
		if (11 == a.b || 10 == a.b)
			return b instanceof A ? b : this.b(a.m.prototype.f(), b);
		if (14 == a.b) {
			if (u(b) && qa.test(b)) {
				var c = Number(b);
				if (0 < c) return c;
		...
		if (c === String) {
			...
			c === Number &&
			u(b) &&
			('Infinity' === b || '-Infinity' === b || 'NaN' === b || qa.test(b))
		)
			return Number(b);
		return b;
	};
	...
	ra.prototype.a = function(a, b) {
		return 8 == a.b ? !!b : I.prototype.a.apply(this, arguments);
	};
	function K(a, b) {
	...
	N.prototype.f = function() {
		...
		a ||
			(ua = a = H(N, {
				...
				19: { name: 'number_format', i: !0, c: 11, type: L },
				20: { name: 'intl_number_format', i: !0, c: 11, type: L },
				22: {
	...
	O.prototype.f = function() {
		...
		a ||
			(va = a = H(O, {
				...
				6: { name: 'country_code_source', c: 14, defaultValue: 0, type: wa },
		...
		xa = {
			...
			AG: [
				...
				[
					,
					,
					'268(?:464|7(?:2\\d|3[246]|64|7[0-689]|8[02-68]))\\d{4}',
					,
					,
					,
					'2684641234',
			...
			AL: [
				...
				[
					,
					,
					'(?:2(?:1(?:0[2-9]|[1-9]\\d)|[247]\\d{2}|[35][2-9]\\d|[68](?:0[2-9]|[1-9]\\d)|9(?:[089][2-9]|[1-7]\\d))|3(?:1(?:[04-9][2-9]|[1-3]\\d)|[2-6]\\d{2}|[79](?:[09][2-9]|[1-8]\\d)|8(?:0[2-9]|[1-9]\\d))|4\\d{3}|5(?:1(?:[05-9][2-9]|[1-4]\\d)|[2-578]\\d{2}|6(?:[06-9][2-9]|[1-5]\\d)|9(?:[089][2-9]|[1-7]\\d))|8(?:[19](?:[06-9][2-9]|[1-5]\\d)|[2-6]\\d{2}|[78](?:[089][2-9]|[1-7]\\d)))\\d{4}',
					,
					,
					,
					'22345678',
			...
			AM: [
				...
				[
					,
					,
					'(?:1[0-2]\\d|2(?:2[2-46]|3[1-8]|4[2-69]|5[2-7]|6[1-9]|8[1-7])|3[12]2|47\\d)\\d{5}',
					,
					,
					,
					'10123456',
			...
			AR: [
				,
				[, , '11\\d{8}|[2368]\\d{9}|9\\d{10}', , , , , , , [10, 11], [6, 7, 8]],
				[
					,
					,
			...
			AU: [
				,
				[, , '1\\d{4,9}|[2-578]\\d{8}', , , , , , , [5, 6, 7, 8, 9, 10]],
				[
					,
					,
			...
			AX: [
				...
				[
					,
					,
					'10(?:0\\d{4,6}|[1-9]\\d{5,7})|2(?:0(?:0\\d{4,6}|[13-8]\\d{5,7}|2(?:[023]\\d{4,5}|[14-9]\\d{4,6})|9(?:[0-7]\\d{4,6}|[89]\\d{1,6}))|9\\d{6,8})|3(?:0(?:0\\d{3,7}|[1-57-9]\\d{5,7}|6(?:\\d{3}|\\d{5,7}))|93\\d{5,7})|60(?:[12]\\d{5,6}|6\\d{7})|7(?:1\\d{7}|3\\d{8}|5[03-9]\\d{5,6})',
					,
					,
					,
					'10112345',
			...
			AZ: [
				...
				[
					,
					,
					'(?:1[28]\\d{3}|2(?:02|1[24]|2[2-4]|33|[45]2|6[23])\\d{2}|365(?:[0-46-9]\\d|5[0-35-9]))\\d{4}',
					,
					,
					,
					'123123456',
			...
			BG: [
				,
				[, , '[23567]\\d{5,7}|[489]\\d{6,8}', , , , , , , [6, 7, 8, 9], [4, 5]],
				[
					,
					,
			...
			BS: [
				...
				[
					,
					,
					'242(?:3(?:5[79]|[79]5)|4(?:[2-4][1-9]|5[1-8]|6[2-8]|7\\d|81)|5(?:2[45]|3[35]|44|5[1-9]|65|77)|6[34]6|7(?:27|38)|8(?:0[1-9]|1[02-9]|2\\d|99))\\d{4}',
					,
					,
					,
					'2423591234',
			...
			CC: [
				,
				[, , '[1458]\\d{5,9}', , , , , , , [6, 7, 9, 10], [8]],
				[, , '89162\\d{4}', , , , '891621234', , , [9], [8]],
				[
					,
					,
			...
			CL: [
				,
				[, , '(?:[2-9]|600|123)\\d{7,8}', , , , , , , [9, 10, 11], [7, 8]],
				[
					,
					,
					'2(?:1962\\d{4}|2\\d{7}|32[0-2467]\\d{5})|(?:3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|9[3-9])\\d{7}',
					,
					,
					,
					'221234567',
			...
			CN: [
				...
				[
					,
					,
					'1(?:[38]\\d|4[57]|5[0-35-9]|7[0-35-8])\\d{8}',
					,
					,
					,
					'13123456789',
			...
			CR: [
				...
				[
					,
					,
					'5(?:0[01]|7[0-3])\\d{5}|6(?:[0-4]\\d{3}|500[01])\\d{3}|(?:7[0-3]|8[3-9])\\d{6}',
					,
					,
					,
					'83123456',
			...
			CX: [
				,
				[, , '[1458]\\d{5,9}', , , , , , , [6, 7, 8, 9, 10]],
				[, , '89164\\d{4}', , , , '891641234', , , [9], [8]],
				[
					,
					,
					'14(?:5\\d|71)\\d{5}|4(?:[0-2]\\d|3[0-57-9]|4[47-9]|5[0-25-9]|6[6-9]|7[02-9]|8[147-9]|9[017-9])\\d{6}',
			...
			DE: [
				...
				[
					,
					,
					'2\\d{5,13}|3(?:0\\d{3,13}|2\\d{9}|[3-9]\\d{4,13})|4(?:0\\d{3,12}|\\d{5,13})|5(?:0[2-8]|[1256]\\d|[38][0-8]|4\\d{0,2}|[79][0-7])\\d{3,11}|6(?:\\d{5,13}|9\\d{3,12})|7(?:0[2-8]|[1-9]\\d)\\d{3,10}|8(?:0[2-9]|[1-8]\\d|9\\d?)\\d{3,10}|9(?:0[6-9]\\d{3,10}|1\\d{4,12}|[2-9]\\d{4,11})',
					,
					,
					,
					'30123456',
			...
			EC: [
				,
				[, , '1\\d{9,10}|[2-8]\\d{7}|9\\d{8}', , , , , , , [8, 9, 10, 11], [7]],
				[, , '[2-7][2-7]\\d{6}', , , , '22123456', , , [8], [7]],
				[
					,
					,
					'9(?:(?:39|[45][89]|7[7-9]|[89]\\d)\\d|6(?:[017-9]\\d|2[0-4]))\\d{5}',
					,
					,
					,
					'991234567',
			...
			FI: [
				...
				[
					,
					,
					'[16]\\d{6,9}|2\\d{4,9}|[35]\\d{5,9}|4\\d{7,10}|7\\d{7,9}|[89]\\d{6,8}',
					,
					,
					,
					,
			...
			GW: [
				,
				[, , '(?:4(?:0\\d{5}|4\\d{7})|9\\d{8})', , , , , , , [7, 9]],
				[, , '443\\d{6}', , , , '443201234', , , [9]],
				[
					,
					,
					'9(?:5(?:5\\d|6[0-2])|6(?:5[0-2]|6\\d|9[012])|77\\d)\\d{5}',
					,
					,
					,
					'955012345',
			...
			HK: [
				...
				[
					,
					,
					'(?:5(?:[1-59][0-46-9]|6[0-4689]|7[0-2469])|6(?:0[1-9]|[1459]\\d|[2368][0-57-9]|7[0-79])|9(?:0[1-9]|1[02-9]|[2358][0-8]|[467]\\d))\\d{5}',
					,
					,
					,
					'51234567',
				...
				[
					,
					,
					'7(?:1[0-369]|[23][0-37-9]|47|5[1578]|6[0235]|7[278]|8[236-9]|9[025-9])\\d{5}',
					,
					,
					,
					'71234567',
			...
			HN: [
				...
				[
					,
					,
					'2(?:2(?:0[019]|1[1-36]|[23]\\d|4[04-6]|5[57]|7[01389]|8[0146-9]|9[012])|4(?:07|2[3-59]|3[13-689]|4[0-68]|5[1-35])|5(?:16|4[03-5]|5\\d|6[4-6]|74)|6(?:[056]\\d|17|3[04]|4[0-378]|[78][0-8]|9[01])|7(?:6[46-9]|7[02-9]|8[034])|8(?:79|8[0-35789]|9[1-57-9]))\\d{4}',
					,
					,
					,
					'22123456'
			...
			HR: [
				...
				[
					,
					,
					'9(?:01\\d|[1259]\\d{2}|7(?:[0679]\\d|51)|8\\d{1,2})\\d{5}',
					,
					,
					,
					'921234567',
			...
			HU: [
				...
				[
					,
					,
					'(?:1\\d|2[2-9]|3[2-7]|4[24-9]|5[2-79]|6[23689]|7[2-9]|8[2-57-9]|9[2-69])\\d{6}',
					,
					,
					,
					'12345678',
			...
			IL: [
				...
				[
					,
					,
					'7(?:18\\d|2[23]\\d|3[237]\\d|47\\d|6[58]\\d|7\\d{2}|8(?:2\\d|33|55|77|81)|9[2579]\\d)\\d{5}',
					,
					,
					,
					'771234567',
			...
			IR: [
				...
				[
					,
					,
					'(?:(?:1[137]|2[13-68]|3[1458]|4[145]|5[1468]|6[16]|7[1467]|8[13467])(?:\\d{8}|(?:[16]|[289]\\d?)\\d{3}))|94(?:000|11[1-7]|2\\d{2}|440)\\d{5}',
					,
					,
					,
					'2123456789',
				...
				[
					,
					,
					'9(?:0[1-3]\\d{2}|[1-3]\\d{3}|9(?:0\\d{2}|44\\d|810|9(?:00|11|9[89])))\\d{5}',
					,
					,
					,
					'9123456789',
			...
			IS: [
				...
				[
					,
					,
					'(?:6(?:2[78]|49|8\\d)|8(?:7[0189]|80)|95[48])\\d{4}',
					,
					,
					,
					'6271234',
			...
			JM: [
				...
				[
					,
					,
					'876(?:2[14-9]\\d|[348]\\d{2}|5(?:0[3-9]|[2-57-9]\\d|6[0-24-9])|7(?:0[07]|7\\d|8[1-47-9]|9[0-36-9])|9(?:[01]9|9[0579]))\\d{4}',
					,
					,
					,
					'8762101234',
			...
			JO: [
				...
				[
					,
					,
					'7(?:55|7[025-9]|8[0-25-9]|9[0-25-9])\\d{6}',
					,
					,
					,
					'790123456',
			...
			KE: [
				,
				[, , '20\\d{6,7}|[4-9]\\d{6,9}', , , , , , , [7, 8, 9, 10]],
				[
					,
					,
					'20\\d{6,7}|4(?:0\\d{6,7}|[136]\\d{7}|[245]\\d{5,7})|5(?:[08]\\d{7}|[1-79]\\d{5,7})|6(?:[01457-9]\\d{5,7}|2\\d{7}|6\\d{6,7})',
					,
					,
					,
					'202012345',
				...
				[
					,
					,
					'7(?:[0-3679]\\d|4[0-4679]|5[0-6]|8[0-25-9])\\d{6}',
					,
					,
					,
					'712123456',
			...
			KI: [
				,
				[, , '[2458]\\d{4}|3\\d{4,7}|7\\d{7}', , , , , , , [5, 8]],
				[
					,
					,
					'(?:[24]\\d|3[1-9]|50|8[0-5])\\d{3}|7(?:27|31|5[0-4])\\d{5}',
					,
					,
					,
					'31234'
			...
			KP: [
				,
				[, , '1\\d{9}|[28]\\d{7}', , , , , , , [8, 10], [6, 7]],
				[, , '2\\d{7}|85\\d{6}', , , , '21234567', , , [8], [6, 7]],
			...
			KW: [
				...
				[
					,
					,
					'(?:5(?:[05]\\d{2}|1[0-7]\\d|2(?:22|5[25])|6[56]\\d)|6(?:0[034679]\\d|222|5[015-9]\\d|6\\d{2}|7[067]\\d|9[0369]\\d)|9(?:0[09]\\d|22\\d|4[01479]\\d|55\\d|6[0679]\\d|[79]\\d{2}|8[057-9]\\d))\\d{4}',
					,
					,
					,
					'50012345',
			...
			LR: [
				,
				[, , '2\\d{7,8}|[378]\\d{8}|4\\d{6}|5\\d{6,8}', , , , , , , [7, 8, 9]],
				[, , '(?:2\\d{3}|33333)\\d{4}', , , , '21234567', , , [8, 9]],
				[
					,
					,
					'(?:20\\d{2}|330\\d|4[67]|5(?:55)?\\d|77\\d{2}|88\\d{2})\\d{5}',
					,
					,
					,
					'770123456',
			...
			ME: [
				...
				[
					,
					,
					'(?:20[2-8]|3(?:0[2-7]|[12][235-7]|3[24-7])|4(?:0[2-467]|1[267])|5(?:0[2467]|1[267]|2[2367]))\\d{5}',
					,
					,
					,
					'30234567',
			...
			MM: [
				...
				[
					,
					,
					'1(?:2\\d{1,2}|[35]\\d|4(?:\\d|2[236]|39)|6\\d?|[89][0-6]\\d)\\d{4}|2(?:2(?:000\\d{3}|\\d{4})|3\\d{4}|4(?:0\\d{5}|26\\d{4}|39\\d{4}|\\d{4})|5(?:1\\d{3,6}|[02-9]\\d{3,5})|[6-9]\\d{4})|4(?:2[245-8]|3(?:2(?:02)?|[346]|56?)|[46][2-6]|5[3-5])\\d{4}|5(?:2(?:2(?:\\d{1,2})?|[3-8])|3[2-68]|4(?:21?|[4-8])|5[23]|6[2-4]|7[2-8]|8[24-7]|9[2-7])\\d{4}|6(?:0[23]|1(?:2(?:0|4\\d)?|[356])|2[2-6]|3[24-6]|4(?:2(?:4\\d)?|[3-6])|5[2-4]|6[2-8]|7(?:[2367]|4(?:\\d|39)|5\\d?|8[145]\\d)|8[245]|9(?:20?|4))\\d{4}|7(?:[04][24-8]|1(?:20?|[3-7])|22|3[2-4]|5[2-7])\\d{4}|8(?:1(?:2\\d{1,2}|[3-689]\\d)|2(?:2\\d|3(?:\\d|20)|[4-8]\\d)|3[24]\\d|4[24-7]\\d|5[245]\\d|6[23]\\d)\\d{3}',
					,
					,
					,
					'1234567',
			...
			MU: [
				...
				[
					,
					,
					'5(?:2[59]\\d|4(?:2[1-389]|4\\d|7[1-9]|9\\d)|7\\d{2}|8(?:[0-25689]\\d|4[3479]|7[15-8])|9[0-8]\\d)\\d{4}',
					,
					,
					,
					'52512345',
			...
			MV: [
				,
				[, , '[346-8]\\d{6,9}|9(?:00\\d{7}|\\d{6})', , , , , , , [7, 10]],
				[
					,
					,
					'(?:3(?:0[0-3]|3[0-59])|6(?:[57][02468]|6[024568]|8[024689]|90))\\d{4}',
					,
					,
					,
					'6701234',
			...
			MY: [
				...
				[
					,
					,
					'1(?:1[1-6]\\d{2}|[02-4679][2-9]\\d|59\\d{2}|8(?:1[23]|[2-9]\\d))\\d{5}',
					,
					,
					,
					'123456789',
			...
			NZ: [
				,
				[, , '6[235-9]\\d{6}|[2-57-9]\\d{7,9}', , , , , , , [8, 9, 10], [7]],
				[
					,
					,
			...
			PG: [
				...
				[
					,
					,
					'(?:3[0-2]\\d|4[257]\\d|5[34]\\d|64[1-9]|77(?:[0-24]\\d|30)|85[02-46-9]|9[78]\\d)\\d{4}',
					,
					,
					,
					'3123456',
			...
			PK: [
				...
				[
					...
					[
						...
						'$1 $2',
						[
							'2[349]|45|5(?:4|8[12])|60|72|8[2-5]|9[2-9]',
							'(?:2[349]|45|5(?:4|8[12])|60|72|8[2-5]|9[2-9])\\d[2-9]'
						],
						'(0$1)'
					],
					[, '(3\\d{2})(\\d{7})', '$1 $2', ['3'], '0$1'],
			...
			PL: [
				,
				[, , '[12]\\d{6,8}|[3-57-9]\\d{8}|6\\d{5,8}', , , , , , , [6, 7, 8, 9]],
				[
					,
					,
			...
			PY: [
				,
				[, , '5[0-5]\\d{4,7}|[2-46-9]\\d{5,8}', , , , , , , [6, 7, 8, 9], [5]],
				[
					,
					,
			...
			SE: [
				,
				[, , '[1-35-9]\\d{5,11}|4\\d{6,8}', , , , , , , [6, 7, 8, 9, 10, 12]],
				[
					,
					,
			...
			SI: [
				...
				[
					,
					,
					'(?:[37][01]\\d|4[0139]\\d|51\\d|6(?:[48]\\d|9[69]))\\d{5}',
					,
					,
					,
					'31234567',
			...
			TH: [
				,
				[, , '[2-9]\\d{7,8}|1\\d{3}(?:\\d{5,6})?', , , , , , , [4, 8, 9, 10]],
				[
					,
					,
			...
			TR: [
				...
				[
					,
					,
					'5(?:(?:0[1-7]|22|[34]\\d|5[1-59]|9[246])\\d{2}|6161)\\d{5}',
					,
					,
					,
					'5012345678',
			...
			TW: [
				,
				[, , '2\\d{6,8}|[3-689]\\d{7,8}|7\\d{7,9}', , , , , , , [7, 8, 9, 10]],
				[
					,
					,
					'2(?:[235-8]\\d{7}|4\\d{6,7})|[3-8]\\d{7,8}',
					,
					,
					,
					'221234567',
			...
			UG: [
				...
				[
					,
					,
					'20(?:[0147]\\d{2}|2(?:40|[5-9]\\d)|3(?:0[0-4]|[23]\\d)|5[0-4]\\d|6[035-9]\\d|8[0-2]\\d)\\d{4}|[34]\\d{8}',
					,
					,
					,
					'312345678',
				...
				[
					,
					,
					'7(?:(?:0[0-7]|[15789]\\d|30|4[0-4])\\d|2(?:[03]\\d|60))\\d{5}',
					,
					,
					,
					'712345678'
			...
			VN: [
				...
				[
					,
					,
					'(?:2(?:0[3-9]|1[0-689]|2[0-25-9]|3[2-9]|[48][2-7]|5[124-9]|6[0-39]|7[0-7]|9[0-4679])|4\\d|5(?:0[01]|[5-9])|6(?:[0-46-8]|5[01])|7[0235])\\d{7}|8(?:[2-5]\\d|6[236]|7[13])\\d{6}',
					,
					,
					,
					'2101234567',
			...
			ZW: [
				...
				[
					,
					,
					'2(?:[0-2457-9]\\d{3,8}|6(?:[14]\\d{7}|\\d{4}))|[13-79]\\d{4,9}|8[06]\\d{5,8}',
					,
					,
					,
					,
...
*/
	...
	function Ma(a, b) {
		for (var c = new K(), d, e = a.length, f = 0; f < e; ++f)
	...
	function T(a) {
		...
		var b = '' + B(a, 2);
		return null != a.a[4] && B(a, 4) && 0 < F(a, 8)
			? Array(F(a, 8) + 1).join('0') + b
			: b;
	}
	function Ra(a, b, c, d) {
		switch (b) {
	...
	function Y(a, b, c, d) {
		...
		if (2 == d)
			if (Oa(W(c, 0)))
				(a = W(c, 1)),
					Oa(a) &&
						((f = f.concat(G(a, 9) ? D(a, 9) : D(B(c, 1), 9))),
						y(f),
						e.length ? ((e = e.concat(D(a, 10))), y(e)) : (e = D(a, 10)));
	...
	function Va(a, b, c, d, e, f) {
		...
		var h = b.toString();
		if (h.length)
			if (R.test(h)) (h = h.replace(R, '')), (b.b = ''), b.a(La(h)), (g = 1);
			else {
				h = new RegExp(g);
				Na(b);
				g = b.toString();
				if (g.search(h)) g = !1;
					...
					k && null != k[1] && 0 < k[1].length && '0' == Ma(k[1], ya)
						? (g = !1)
		...
		if (
			...
			(k = b.toString()),
			!k.lastIndexOf(h, 0) &&
				((h = new K(k.substring(h.length))),
				(k = B(c, 1)),
				(k = new RegExp(F(k, 2))),
				Wa(h, c, null),
				(h = h.toString()),
				(!S(k, b.toString()) && S(k, h)) || 3 == Y(a, b.toString(), c, -1)))
		)
			return d.a(h), e && C(f, 6, 10), C(f, 1, g), g;
		C(f, 1, 0);
		return 0;
	}
	function Wa(a, b, c) {
		...
		if (e && null != f && f.length) {
			...
			if ((e = g.exec(d))) {
				...
				if (null != b && b.length && null != e[k] && e[k].length) {
					if (((d = d.replace(g, b)), !h || S(f, d)))
						c && 0 < k && c.a(e[1]), a.set(d);
				} else if (!h || S(f, d.substring(e[0].length)))
					c && 0 < k && null != e[k] && c.a(e[1]),
						a.set(d.substring(e[0].length));
			}
		}
	}
	function Z(a, b, c) {
		if (!Pa(c) && 0 < b.length && '+' != b.charAt(0))
			throw Error('Invalid country calling code');
		return Xa(a, b, c, !0);
	}
	function Xa(a, b, c, d) {
		...
		f = e.toString();
		g = f.indexOf(';isub=');
		0 < g && ((e.b = ''), e.a(f.substring(0, g)));
		if (!Ka(e.toString()))
			throw Error('The string supplied did not seem to be a phone number');
		f = e.toString();
		if (!(Pa(c) || (null != f && 0 < f.length && R.test(f))))
			throw Error('Invalid country calling code');
		f = new O();
		d && C(f, 5, b);
		a: {
		...
		h
			? ((e = Sa(h)), e != c && (b = U(a, h, e)))
			: (Na(e),
			  g.a(e.toString()),
			  null != c
					? ((h = F(b, 10)), C(f, 1, h))
					: d && (delete f.a[6], f.b && delete f.b[6]));
		if (2 > g.b.length)
		...
		b &&
			...
			(e = new K(g.toString())),
			Wa(e, b, c),
			2 != Y(a, e.toString(), b, -1) &&
				((g = e), d && 0 < c.toString().length && C(f, 7, c.toString())));
		a = g.toString();
		d = a.length;
		if (2 > d)
			throw Error('The string supplied is too short to be a phone number');
	...
	v('intlTelInputUtils.getValidationError', function(a, b) {
		try {
			...
			return 'Invalid country calling code' == k.message
				? 1
				: 'The string supplied did not seem to be a phone number' == k.message
				? 4
				: 'Phone number too short after IDD' == k.message ||
				  'The string supplied is too short to be a phone number' == k
				? 2
				: 'The string supplied is too long to be a phone number' == k.message
				? 3
				: -99;
		}
	});
