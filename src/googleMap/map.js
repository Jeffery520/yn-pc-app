google.maps.__gjsload__('map', function(_) {
	var Mu = function() {
		...
		bv = function(a, b, c, d, e) {
			...
			var f = void 0 === e ? {} : e;
			e = void 0 === f.Ki ? _.p(!0) : f.Ki;
			var g = void 0 === f.Bl ? !1 : f.Bl,
				h = void 0 === f.zj ? _.p(null) : f.zj;
			f = {
		...
		ev = function(a) {
			return new _.mq([a.draggable, a.vl, a.Rf], _.Gl(dv, cv));
		},
		fv = function(a) {
			this.i = new Su();
			this.j = a;
		...
		zv = function(a) {
			...
			return function(c) {
				var d = yv(a, 'roadmap', a.i, { fl: !1, jc: b(3, c.jc().get()) }),
		...
		Av = function(a) {
			return function(b, c) {
				var d = b.jc().get(),
					e = yv(a, 'satellite', null, { heading: b.heading, jc: d, Fi: !1 });
	...
	Zu.prototype.Ed = function(a, b) {
		...
		this.i ||
			...
			(b = Gw(this.o, function() {
				...
				? (this.i = { origin: a.Gb, xn: this.o.i.i.zoom, Ue: b })
				: this.H.reset());
	};
	Zu.prototype.Be = function(a) {
		if (this.i) {
			...
			Dw(this.i.Ue, {
				center: b.center,
				zoom: this.i.xn + (a.Gb.clientY - this.i.origin.clientY) / 128,
				heading: b.heading,
				tilt: b.tilt
			});
		}
		...
		if (h) {
			...
			var cA = function(ea, db, Vb) {
				...
				if (Cf && null != bA && xO) {
					...
					Gc.Yf(
						{
							center: _.em(_.rn(Cf, xO), _.Hd(i5, { wa: ea, Ca: db })),
							zoom: bA,
							heading: zO,
							tilt: yO
						},
			...
			a.i ||
				((ic = function() {
					...
					_.P('controls').then(function(ea) {
						var db = new ea.di(k.H);
						g.set('layoutManager', db);
						ea.ym(db, a, U, k.H, v, t.report_map_issue, Df, th, c, wa, h5, Gc);
						ea.zm(a, k.o);
						ea.Th(c);
					});
				}),
