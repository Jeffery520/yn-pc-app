google.maps.__gjsload__('poly', function(_) {
	var VW = function(a) {
		...
		jX = function(a) {
			if (a.j) {
				...
				if (b) {
					...
					var c = ['#', VW(b.o), VW(b.j), VW(b.i)].join('');
				}
			}
		...
		qX = function(a, b, c) {
			...
			this.o = !1;
			this.$ = c;
			_.N.bind(this.i, 'set_at', this, this.Io);
		},
		raa = function(a) {
			var b = a.get('panes');
			if (!b) return null;
		...
		taa = function(a, b, c, d) {
			function e() {
				a.get('editable')
					? saa(a, b, c, d)
					: (tX(a), _.N.trigger(a, 'toolbar', { i: !1 }));
			}
			...
			this.Ja = new _.ji(function() {
				...
				if (f) {
					var g = b.get('radius'),
						h = b.get('center');
					_.fd(g) && h
						? ((g /= b.get('planetRadius')), f.setPaths(waa(h, g)))
						: f.setPaths([]);
				}
			}, 0);
		},
		...
		yaa = function(a, b) {
			_.P('geometry').then(function(c) {
				a.o = new BX(
					function(d, e, f) {
						return new uX(d, e, f, c.computeHeading, c.computeOffsetOrigin);
					},
					a.j,
					b
				);
		...
		LX = function(a, b, c) {
			...
			a.i = function(e) {
				...
				f = e.dg = { style: HX(d.T, e), geometry: IX(e, f) };
				JX(d, e);
				e.changed = d.W;
				_.Ze(d.H, f);
			};
		...
		KX = function(a) {
			...
			if (b) {
				...
				OX(b, a);
				b = b.getArray();
				for (var c = 0, d = b.length; c < d; ++c) OX(b[c], a);
			}
		},
		NX = function(a) {
			a.j ||
		...
		RX = function(a) {
			...
			_.Ry(b, 'pointer');
			_.Ny(b);
			this.i = _.kE(Daa, b, _.pk, PX);
			_.N.bind(this, 'toolbar', this, this.Ck);
			var c = this;
			this.H = new _.By(
				a.j,
				{
					Ke: function(d) {
						d &&
							((d = new _.I(d.wa, d.Ca)),
							_.mo(c.j, new _.I(d.x + QX.x, d.y + QX.y)));
					},
					He: _.n()
				},
				null,
		...
		UX = function(a, b, c) {
			...
			this.i = c;
			this.Fa = [
				_.N.bind(a, 'set_at', this, this.tn),
				_.N.bind(a, 'insert_at', this, this.kj),
				_.N.bind(a, 'remove_at', this, this.mn)
			];
			b = 0;
			for (a = a.getLength(); b < a; ++b) this.kj(b);
		},
		WX = function(a, b, c) {
			...
			if (d) {
				var e = a.j,
					...
					g = a.o,
					h = a.get('geodesic');
				0 < c && g.setAt(c - 1, VX(e.getAt(c - 1), f, h, d, a.i));
				c < e.getLength() - 1 &&
					((a = VX(f, e.getAt(c + 1), h, d, a.i)),
		...
		ZX = function(a, b, c, d) {
			var e = new mX(b, ['pointer'], [0], d, c, a.ka, a.get('map'), a.ta);
			...
			_.B(xX, function(f) {
				_.N.addListener(e, f, function(g) {
					...
					_.N.trigger(
						a,
						f,
						new XX(h, void 0, m, d ? void 0 : g, d ? g : void 0)
					);
				});
			});
			return e;
		...
		fY = function(a, b, c, d) {
			...
			b = this.H;
			this.W = Math.min(
				bX(c, a, new _.I(b.Ka, b.Ia)),
				bX(c, a, new _.I(b.Pa, b.Oa))
			);
			this.ua = Naa(this.j, this.W, c);
			this.o = Jaa(e);
		},
			...
			for (h = b.length; g < h; ++g) {
				...
				if (l.path.length) {
					...
					if (q.length) {
						...
						for (t = 0; (q = m[t]); ++t)
							(q = Oaa(l, q.offset, q.repeat, k)) && (f[t] = f[t].concat(q));
					}
				}
			}
			return { paths: e, sg: f };
		...
		Taa = function(a, b, c, d, e) {
			function f() {
				a.get('editable')
					? (Saa(a, b, d, e), _.ij(b, 'Oe'), _.uo('Oe', '-p', a))
					: (_.N.trigger(c, 'toolbar', { i: !1, poly: a }), hY(a));
			}
		...
		Uaa = function(a, b, c, d, e) {
			...
			this.$ = d;
			this.T = b;
			this.j = jY(a, this.i, e);
			_.mo(this.j, _.pk);
			this.W = kY(this.j, e);
			this.ka = jY(a, this.i, e);
			this.ta = kY(this.ka, e);
		...
		oY = function(a, b) {
			...
			a = a.i.search(d);
			d = 0;
			for (var e = a.length; d < e; ++d) qY(b, a[d].Pe || null);
		...
		dba = function(a) {
			a.length && ((a = rY(a, bba)), (a = rY(a, cba)));
			return a;
		},
		rY = function(a, b) {
			var c = [],
			...
			for (var h = 2, k = 2; h < a.length; ) {
				...
				c[1] = a[h + 1];
				gX(c, f);
				b(d, f, e) && (hX(e, c), (g[k++] = c[0]), (g[k++] = c[1]));
				g[k++] = a[h++];
				g[k++] = a[h++];
				var l = d;
				d = f;
		...
		bba = function(a, b, c) {
			...
			fX(sY, tY, c);
			c.z = 0;
			if (1e-12 > dX(c, c)) return !1;
			0 > dX(c, a) + dX(c, b) && ((c.x = -c.x), (c.y = -c.y));
			return !0;
		},
		cba = function(a, b, c) {
			fX(a, b, sY);
			fX(tY, sY, uY);
			fX(sY, uY, c);
			if (1e-12 > dX(c, c) || 0 < dX(a, uY) == 0 < dX(b, uY)) return !1;
			0 > dX(c, a) + dX(c, b) && ((c.x = -c.x), (c.y = -c.y), (c.z = -c.z));
			return !0;
		},
		fba = function(a, b, c) {
			if (!b) return null;
			...
			a && _.B(d, iaa);
			if (c) for (a = 0, b = d.length; a < b; ++a) d[a] = dba(d[a]);
			return d;
		},
		gba = function(a) {
			return _.cd(a, function(b) {
		...
		HX = function(a, b) {
			...
			d.o = b.get('hitStrokeWeight') || mba(d.strokeWeight, d.strokePosition);
			d.i = [];
			d.j = 1;
			if (!e) {
				e = b.get('icons') || [];
		...
		oba = function(a) {
			...
			this.i = a.__gm;
			var c = new _.Ye();
			new LX(this.i.H, c, new lba(), new hba()).bindTo('projection', a);
			var d = _.Jd(-100, -200, 100, 200),
				e = new _.jF(d);
			d = new _.jF(d);
			this.ta = new _.Ye();
			new Xaa(c, e, this.ta, d);
			var f = _.ho(a.getDiv()),
				g = void 0,
				h = null;
		...
		vY = function(a, b) {
			if (a.$ && a.H && a.T && a.o && a.W) {
				EX(b, a.$);
				Taa(b, a.j, a.H, a.o.interpolate, a.W);
				Aaa(b, a.i, a.T, a.i.o);
				if (!b.Df) {
					var c = b.ac ? 'Op' : 'Ol';
					_.ij(a.j, c);
		...
		yY = function(a, b, c) {
			...
			this.o = this.T = null;
			this.j = new _.Xe();
			_.N.bind(this.j, 'set_at', this, this.Go);
			this.H = new _.Xe();
			_.N.bind(this.H, 'set_at', this, this.Ho);
			this.i = !1;
			this.$ = c;
		},
		BY = function(a, b, c) {
		...
		vba = function(a, b, c) {
			function d() {
				a.get('editable')
					? uba(a, b, c)
					: (EY(a), _.N.trigger(a, 'toolbar', { i: !1 }));
			}
		...
		IY = _.n(),
		xX = 'click dblclick mousedown mousemove mouseout mouseover mouseup rightclick'.split(
			' '
		);
	_.A(ZW, _.O);
	...
	ZW.prototype.handleEvent = function(a, b, c) {
	...
	ZW.prototype.zIndex = Infinity;
	var $W = {};
	cX.prototype.equals = function(a) {
		return this.x == a.x && this.y == a.y && this.z == a.z;
	};
	_.A(iX, _.O);
	iX.prototype.j = function(a, b, c, d, e) {
	...
	kX.prototype.position_changed = function() {
	...
	kX.prototype.color_changed = function() {
	...
	mX.prototype.zIndex_changed = function() {
		var a = this.get('zIndex') || 0;
		this.W && --a;
		_.oo(this.H, a);
	};
	mX.prototype.$ = function(a, b) {
		var c = this,
			d = {};
		d.index = b;
		c.j.splice(b, 0, d);
		...
		f.push(
			_.N.addListener(e, 'dragend', function() {
				...
				if (
					g &&
					c.i &&
					((g = _.sn(g, c.i.get('projection'))), (g = nX(c, d, g))) &&
	...
	_.A(qX, _.O);
	var paa = ['pointer', 'row-resize', 'row-resize', 'col-resize', 'col-resize'],
		qaa = [0, 2, 2, 1, 1];
	_.r = qX.prototype;
	_.r.map_changed = function() {
		this.get('map') ||
			(this.T.set('map', null), rX(this), _.N.clearInstanceListeners(this.i));
	};
	...
	_.r.center_changed = qX.prototype.Hh;
	_.r.radius_changed = qX.prototype.Hh;
	_.r.planetRadius_changed = qX.prototype.Hh;
	_.r.Io = function(a) {
		if (!this.o) {
	...
	sX.prototype.construct = function(a, b, c, d, e) {
	...
	uX.prototype.i = function(a) {
		...
		b ||
			(b =
				Math.abs(_.yx(a, JY) - this.j) < Math.abs(_.yx(a, KY) - this.j)
					? JY
					: KY);
		this.o.set('center', b);
	};
	...
	_.r.equals = function(a) {
		return 1e-9 >= (Math.abs(a.i - this.i) % 360) + Math.abs(vX(a) - vX(this));
	};
	_.r.center = function() {
	...
	_.A(yX, _.O);
	yX.prototype.center_changed = function() {
		_.ki(this.Ja);
	};
	yX.prototype.radius_changed = function() {
		_.ki(this.Ja);
	};
	yX.prototype.planetRadius_changed = function() {
		_.ki(this.Ja);
	};
	...
	var LY = new _.K(30, 30),
		yba = new _.I(LY.width / 2, LY.height / 2);
	_.r = BX.prototype;
	_.r.jg = function() {
		if (!this.get('active')) {
			...
			if (a != this.T || b != this.Ra || c != this.i)
				if (
					...
					this.Fa = [
						_.N.bind(this.i, 'mousedown', this, this.jn),
						_.N.bind(this.i, 'mouseup', this, this.ln),
						_.N.bind(this.i, 'movestart', this, this.Ak),
						_.N.bind(this.i, 'move', this, this.Bk),
						_.N.bind(this.i, 'moveend', this, this.zk)
					];
					var d = this;
					this.Fa.push(
	...
	_.r.active_changed = BX.prototype.jg;
	_.r.panes_changed = BX.prototype.jg;
	_.r.poly_changed = BX.prototype.jg;
	_.r.projectionController_changed = BX.prototype.jg;
	_.r.Ak = function(a) {
		!this.get('draggable') ||
			!this.i ||
			(a.tb && _.qm(a.tb)) ||
	...
	_.r.position_changed = function() {
		var a = this.get('position');
		a ? _.SE(this.o, _.ZE(a, LY, yba)) : _.SE(this.o, null);
		this.get('dragging') && (this.ka.i(a), CX(this, 'drag'));
	};
	_.r.Pj = function() {
		_.VE(this.o, 0 != this.get('panningEnabled') && this.get('dragging'));
	};
	_.r.dragging_changed = BX.prototype.Pj;
	_.r.panningEnabled_changed = BX.prototype.Pj;
	...
	_.A(LX, _.O);
	LX.prototype.projection_changed = function() {
		var a = this;
	...
	var Baa = { latLngs: 1, geodesic: 1, icons: 1 },
		Caa = {
			strokeColor: 1,
			strokeOpacity: 1,
			strokePosition: 1,
	...
	_.r.changed = RX.prototype.he;
	_.r.Ck = function(a) {
		a.i && a.poly
			? a.poly.get('suppressUndo')
				? this.he()
				: (a.j && this.H.setPosition(a.j), Gaa(this, a.action, a.poly))
			: a.poly == this.o && this.he();
	};
	_.r.ig = function(a) {
		_.lE(this.i, PX, a);
	};
	var Daa = _.Oo('undo_poly'),
		PX = new _.K(30, 27),
		Faa = new _.I(30, 0),
		Eaa = new _.I(60, 0),
		QX = new _.I(10, -11);
	TX.prototype.getLength = function() {
		var a = this.i.getLength();
		1 < a && ++a;
		return a;
	};
	TX.prototype.getAt = function(a) {
	...
	_.r.Hn = function() {
		...
		if (a)
			for (
				...
				b.setAt(f, VX(c.getAt(f), c.getAt(f + 1), e, a, this.i));
		else b.clear();
	};
	_.r.geodesic_changed = UX.prototype.projection_changed = UX.prototype.Hn;
	_.r.tn = function(a) {
		WX(this, !1, a);
	};
	_.r.kj = function(a) {
	...
	_.r.mn = function(a) {
		...
		if (b) {
			...
			a < c.getLength()
				? (0 < a &&
						d.setAt(a - 1, VX(c.getAt(a - 1), c.getAt(a), e, b, this.i)),
				  d.removeAt(a))
				: 0 < a && d.removeAt(a - 1);
		}
	};
	_.A(XX, _.Xm);
	_.A(YX, _.O);
	YX.prototype.map_changed = function() {
		this.get('map') || (this.T.set('map', null), bY(this));
	};
	YX.prototype.panes_changed = YX.prototype.paths_changed = YX.prototype.suppressGhostControlPoints_changed = function() {
		var a = this;
		bY(a);
		var b = a.get('paths'),
			c = a.get('panes');
		if (b && c) {
			...
			b.forEach(function(f) {
				a.j.push($X(a, f, d));
				a.get('suppressGhostControlPoints') || a.i.push(aY(a, f, d));
			});
			var e = function() {
			...
			c.push(
				_.N.addListener(b, 'insert_at', function(f) {
					var g = a.get('suppressGhostControlPoints'),
						h = b.getAt(f);
					a.j.splice(f, 0, $X(a, h, d));
					g || a.i.splice(f, 0, aY(a, h, d));
					e();
				})
			);
			c.push(
	...
	fY.prototype.getBounds = _.pa('j');
	gY.prototype.j = function(a, b) {
	...
	var zba = new _.I(0.5, 0.5);
	gY.prototype.o = function(a, b) {
		var c = this.T.get();
		if (!c) return null;
		c = c.Wa.size;
		var d = _.gF(this.W, a.ab, zba);
		if (!d) return null;
	...
	gY.prototype.handleEvent = function(a, b, c) {
		!this.i ||
		...
		'mouseout' == a
			...
			: 'mousemove' == a &&
			  ...
			  void 0 === c && (c = 'pointer'),
			  this.H.set('cursor', c));
		_.N.trigger(d, a, new XX(b.latLng, b.tb));
	};
	gY.prototype.zIndex = 30;
	_.Ha(iY, _.Wi);
	iY.prototype.Ob = function() {
	...
	nY.prototype.H = function(a, b) {
		this.i = this.i || Waa(this.j, a, this.o);
		return new Uaa(this.j, b, this.o, this.i, a);
	};
	var tY = new cX(1),
		sY = new cX(0),
		uY = new cX(0);
	...
	var zY = [12, 6, 9, 3],
		AY = [1, 2, 4, 8],
		qba = ['ne-resize', 'nw-resize', 'se-resize', 'sw-resize'],
		sba = ['row-resize', 'col-resize'],
		rba = [0],
		tba = [2, 1];
	_.r = yY.prototype;
	_.r.map_changed = function() {
		this.get('map') ||
			...
			CY(this.T),
			this.get('suppressGhostControlPoints') || CY(this.o),
			_.N.clearInstanceListeners(this.j));
	};
	_.r.panes_changed = yY.prototype.suppressGhostControlPoints_changed = function() {
		CY(this.T);
		CY(this.o);
		this.o = null;
		var a = this.get('panes');
		a &&
			((this.T = BY(this, a, !0)),
			this.get('suppressGhostControlPoints') || (this.o = BY(this, a, !1)));
	};
	...
	_.r.Go = function(a) {
		DY(this, zY[a], this.j.getAt(a));
	};
	_.r.Ho = function(a) {
		DY(this, AY[a], this.H.getAt(a));
	};
	...
	_.A(GY, _.O);
	GY.prototype.bounds_changed = function() {
		var a = this.i;
		if (a) {
	...
	IY.prototype.i = function(a) {
		var b = 0 != a.getVisible() ? a.getMap() : null;
		a.j != b &&
			(a.j && a.j.__gm.T.remove(a),
			b && (b.__gm.T.i || new zaa(b), _.Ze(b.__gm.T, a)),
			(a.j = b));
	};
	IY.prototype.j = function(a) {
		...
		a.o != b &&
			...
			b && (b.__gm.H.i || new oba(b), _.Ze(b.__gm.H, a)),
			(a.o = b));
	};
	IY.prototype.o = function(a) {
		var b = 0 != a.getVisible() ? a.getMap() : null;
		a.j != b &&
			(a.j && a.j.__gm.W.remove(a),
			b && (b.__gm.W.i || new xba(b), _.Ze(b.__gm.W, a)),
			(a.j = b));
	};
	_.If('poly', new IY());
});
