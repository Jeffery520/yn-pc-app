...
google.maps.__gjsload__('common', function(_) {
	...
	hp = function(a, b) {
		var c = ep(bp(a.i)),
			d = (a.o && 1 == c.Zf && a.i.i.Al) || a.i.i.Pd;
	...
	_.Ns = function(a, b) {
		...
		var c = a.Og.get() || Qs;
		b = a.Vc ? b : c;
		a.Di != b && ((a.Db.style.cursor = b), (a.Di = b));
	};
	_.Rs = function(a, b) {
		b = b || new _.$m();
		b.V[0] = 26;
	...
	_.Nt = function(a) {
		...
		a.Bi &&
			...
			Kt(this.T),
			a.km && (this.T.style.backgroundColor = 'rgba(255,255,255,0)'),
	...
	_.r.qc = _.n();
	_.r.Ee = function() {
		if (this.i.i.Xm && 3 != this.T && this.i.i.Xm(this.H))
