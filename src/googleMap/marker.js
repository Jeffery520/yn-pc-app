google.maps.__gjsload__('marker', function(_) {
	...
	cU = function(a, b, c, d, e) {
		...
		this.La = 0;
		this.j = null;
		this.i = new _.ji(this.uk, 0, this);
		this.T = e;
	...
	pU = function(a, b, c) {
		...
		this.Ac = !1;
		this.Lc = [
			_.N.addListener(this, 'dragstart', this.xk),
			_.N.addListener(this, 'dragend', this.wk),
	...
	TU = function(a, b) {
		...
		b.changed = a.W;
		if (!b.get('animating'))
			if ((a.T.remove(b), !c || 0 == b.get('visible') || (b.__gm && b.__gm.Vl)))
				a.i.remove(b);
			else {
	...
	tU[3] = {
		options: { duration: 200, Vf: 20, Dd: 1, Qj: !1 },
		icon: new Animation([
	...
	tU[4] = {
		options: { duration: 500, Vf: 20, Dd: 1, Qj: !1 },
		icon: new Animation([
