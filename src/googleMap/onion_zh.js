google.maps.__gjsload__('onion', function(_) {
	...
	RV = function() {
		return [
			...
			[
				...
				'var',
				function(a) {
					return (a.nm = '#ffffff' == _.W(a.Bb, '', -2, -3));
				},
				'var',
				function(a) {
	...
	aW = function(a, b, c, d, e) {
		...
		this.i = {};
		this.o = e || null;
		_.N.bind(b, 'insert', this, this.Um);
		_.N.bind(b, 'remove', this, this.rn);
		_.N.bind(a, 'insert_at', this, this.Tm);
		_.N.bind(a, 'remove_at', this, this.qn);
		_.N.bind(a, 'set_at', this, this.vn);
	};
	cW = function(a, b) {
	...
	PW = function(a, b) {
		...
		this.Rg();
		OW(this, 'rightclick', 'smnoplacerightclick');
		OW(this, 'mouseover', 'smnoplacemouseover');
		OW(this, 'mouseout', 'smnoplacemouseout');
	};
	aaa = function(a) {
	...
	OW = function(a, b, c) {
		a.H &&
			_.N.addListener(a.H, b, function(d) {
				(d = QW(a, d)) && d.Qd && RW(a.j) && SW(a, c, d.Qd, d.ab, d.Qd.id);
			});
	};
	QW = function(a, b) {
		var c = !_.Pg[35];
	...
	vW.prototype.o = function(a, b) {
		return (b ? faa : gaa).some(function(c) {
			c = _.gF(this.$, a.ab, c);
			if (!c) return !1;
			var d = c.Qe.Ma,
	...
	BW.prototype.load = function(a, b) {
		...
		_.Vs(c, 3);
		_.B(a.i || [], function(g) {
			g.mapTypeId && g.Ri && _.Ws(c, g.mapTypeId, g.Ri, _.Bc(_.Wc(), 15));
		});
		_.B(a.i || [], function(g) {
			...
			if (!b.ya) {
				...
				b.i.then(function(t) {
					...
					_.B(['mouseover', 'mouseout', 'mousemove'], function(v) {
						_.N.addListener(u, v, (0, _.y)(_.TW.Ul, _.TW, v, a, d));
					});
					t.ke.kb(function(v) {
	...
	PW.prototype.Sg = function(a, b) {
		...
		e &&
			e.Qd &&
			(RW(d)
				? SW(this, 'smnoplaceclick', e.Qd, e.ab, e.Qd.id)
				: daa(e.Qd.id, function(f) {
						...
						(k && k.tb && _.qm(k.tb)) ||
							((c.T = a.anchorOffset || _.qk), (c.o = f), caa(c));
				  }));
	};
	UW.prototype.W = function() {
		var a = new _.Ms(),
			b = this.H,
			c = this.i.__gm,
			d = c.get('baseMapType'),
		...
		if (e && 0 != this.i.getClickableIcons()) {
			...
			if (f) {
				...
				a.parameters.salt = (0, _.sj)(
					d + '+' + _.cd(e, eaa).join(',') + c.get('authUser')
				);
